const card = {
    container: 'card rounded-xl overflow-hidden border border-slate-300 shadow-xl bg-white',
    ...
    price: {
        ...
        percentageOff:
            'card__price--off text-[10px] md:text-xs text-white bg-green-600 p-1 rounded',
