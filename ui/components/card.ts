const card = {
  ...
  image: 'card__image object-contain overflow-hidden',
  ...
  store: 'card__store text-xs text-blue-600',
  price: {
    ...
    percentageOff: 'card__price--off text-xs text-white bg-orange-400 p-1 rounded ml-2'
  },
  actions: {
